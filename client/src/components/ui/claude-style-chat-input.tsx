...
export const ClaudeChatInput: React.FC<ClaudeChatInputProps> = ({ onSendMessage, compact = false }) => {
                    ...
                    <div className="relative mb-1">
                        <div className="max-h-96 w-full overflow-y-auto custom-scrollbar font-sans break-words transition-opacity duration-200 min-h-[2.5rem] pl-1">
                            <textarea
                                ...
                                placeholder={compact ? "Ask a follow-up..." : "How can I help you today?"}
                                className="w-full bg-transparent border-0 outline-none text-text-100 text-[15px] placeholder:text-text-400 resize-none overflow-hidden py-0 leading-relaxed block font-normal antialiased"
                                rows={1}
                                autoFocus={!compact}
